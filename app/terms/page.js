    ...
    <div style={{
      ...
      <div style={{ maxWidth: '720px', margin: '0 auto' }}>
        ...
        <div style={{ color: '#B0BEC5', fontSize: '15px', lineHeight: '1.7' }}>
          ...
          <h2 style={{ color: '#FFFFFF', fontFamily: "'Outfit', sans-serif", fontSize: '20px', marginTop: '32px', marginBottom: '12px' }}>7. MLS Data &amp; IDX Compliance</h2>
          ...
          <h2 style={{ color: '#FFFFFF', fontFamily: "'Outfit', sans-serif", fontSize: '20px', marginTop: '32px', marginBottom: '12px' }}>8. Prohibited Conduct</h2>
          ...
          <h2 style={{ color: '#FFFFFF', fontFamily: "'Outfit', sans-serif", fontSize: '20px', marginTop: '32px', marginBottom: '12px' }}>9. Disclaimers</h2>
          ...
          <h2 style={{ color: '#FFFFFF', fontFamily: "'Outfit', sans-serif", fontSize: '20px', marginTop: '32px', marginBottom: '12px' }}>10. Limitation of Liability</h2>
          ...
          <h2 style={{ color: '#FFFFFF', fontFamily: "'Outfit', sans-serif", fontSize: '20px', marginTop: '32px', marginBottom: '12px' }}>11. Intellectual Property</h2>
          ...
          <h2 style={{ color: '#FFFFFF', fontFamily: "'Outfit', sans-serif", fontSize: '20px', marginTop: '32px', marginBottom: '12px' }}>12. Termination</h2>
          ...
          <h2 style={{ color: '#FFFFFF', fontFamily: "'Outfit', sans-serif", fontSize: '20px', marginTop: '32px', marginBottom: '12px' }}>13. Governing Law</h2>
          ...
          <h2 style={{ color: '#FFFFFF', fontFamily: "'Outfit', sans-serif", fontSize: '20px', marginTop: '32px', marginBottom: '12px' }}>14. Changes to Terms</h2>
          <p>We may update these terms from time to time. Continued use of the Service after changes constitutes acceptance of the updated terms.</p>

          <h2 style={{ color: '#FFFFFF', fontFamily: "'Outfit', sans-serif", fontSize: '20px', marginTop: '32px', marginBottom: '12px' }}>15. Contact</h2>
