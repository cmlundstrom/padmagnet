  ...
  return `
    <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;max-width:600px;margin:0 auto;background:#ffffff;border:1px solid #e5e7eb;border-radius:8px;overflow:hidden">
      <div style="background:#0B1D3A;padding:16px 24px;text-align:center">
        <span style="font-size:20px;font-weight:bold;color:#ffffff">Pad</span><span style="font-size:20px;font-weight:bold;color:#F95E0C">Magnet</span>
      </div>
  ...
  const html = tpl?.html || `
    <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;max-width:600px;margin:0 auto;background:#ffffff;border:1px solid #e5e7eb;border-radius:8px;overflow:hidden">
      ...
      <div style="background:#0B1D3A;padding:20px 24px;text-align:center">
        <span style="font-size:22px;font-weight:bold;color:#ffffff">Pad</span><span style="font-size:22px;font-weight:bold;color:#F95E0C">Magnet</span>
      </div>
      ...
      <div style="padding:24px">
        ...
        <div style="text-align:center;margin:0 0 8px">
          <a href="https://padmagnet.com" style="display:inline-block;background:#E8603C;color:#ffffff;text-decoration:none;padding:12px 28px;border-radius:6px;font-size:14px;font-weight:600">Reply to This Lead</a>
        </div>
      </div>
